...
@CucumberOptions(
		...
		tags = {"@"}, // we can run all scenarios or one scenario with help of tags. we can add more tags by help of and. we can also run all scenario/test case by commenting out the tag.
